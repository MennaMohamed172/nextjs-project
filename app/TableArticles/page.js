        ...
        <tbody>
          {items.map((item) => (
            <tr key={item.id}>
              ...
              <td>{item.subtitle}</td>
              <td>
                <button onClick={() => moveToTrash(item.id)} style={{width:"100px",height:"20px",backgroundColor:"#014F86",color:"white",borderRadius:"5px", border:"1px solid white", cursor: "pointer" }}>Move to Trash</button>
                <button onClick={() => saveAsDraft(item.id)} style={{width:"100px",height:"20px",backgroundColor:"#014F86",color:"white",borderRadius:"5px", border:"1px solid white", cursor: "pointer" }}>Save as Draft</button>
