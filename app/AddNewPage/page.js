...
export const metadata = {
  title: 'صفحات مركز مشهور خبراء العيون',
...
export default function TextEditorForm() {
  ...
  return (
    <Box m="20px" ml="180px"  style={{width:"50%",marginTop: "-500px"}} >
     <Header title="Create Page" subtitle="Create A New Page"   />
   ...
   <div className="form-group">
      <FormControl fullWidth variant="filled">
          <TextField
                ...
                InputProps={{
                    style: { fontSize: "26px" ,marginBottom:"20px",width:"790px"},
                  }}
              />
            ...
            style={{ marginTop: "84px",marginRight:"-120px", width:"200px",color:"white" , height:"45px",fontSize:"15px",
              ...
              backgroundColor:"#013A63",
               ...
               <a href="../TablePage"> Add New Page</a> 
              </Button>
            </Box>
          </form>
        )}
